...
public final class RequiresLogPermissionCardKt$RequiresLogPermissionCard$1 extends Lambda implements Function2 {
    public final /* synthetic */ int $$dirty;
    public final /* synthetic */ Function0 $onClickGrant;
    public final /* synthetic */ Function0 $onClickRefuse;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public RequiresLogPermissionCardKt$RequiresLogPermissionCard$1(Function0 function0, int i, Function0 function02) {
        super(2);
        this.$onClickRefuse = function0;
        this.$$dirty = i;
        this.$onClickGrant = function02;
    }
    ...
    public final void invoke(Composer $composer, int $changed) {
        ...
        int i = $changed;
        ComposerKt.sourceInformation(composer, "C27@1049L387:RequiresLogPermissionCard.kt#ypex4d");
        if ((i & 11) != 2 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-886944171, i, -1, "vegabobo.dsusideloader.ui.cards.warnings.RequiresLogPermissionCard.<anonymous> (RequiresLogPermissionCard.kt:26)");
            }
            ...
            Function0 function0 = this.$onClickRefuse;
            int i2 = this.$$dirty;
            Function0 function02 = this.$onClickGrant;
            ...
            ComposerKt.sourceInformationMarkerStart($composer2, 227882783, "C28@1143L283:RequiresLogPermissionCard.kt#ypex4d");
            ...
            ComposerKt.sourceInformationMarkerStart($composer4, 743275862, "C29@1188L36,29@1165L85,30@1267L47,31@1352L35,31@1331L81:RequiresLogPermissionCard.kt#ypex4d");
            ...
            SecondaryButtonKt.SecondaryButton((Modifier) null, StringResources_androidKt.stringResource(C0001R$string.refuse, $composer4, 0), function0, false, $composer4, (i2 << 3) & 896, 9);
            SpacerKt.Spacer(PaddingKt.m225paddingqDBjuR0$default(companion, 0.0f, 0.0f, Dp.m2350constructorimpl((float) LiveLiterals$RequiresLogPermissionCardKt.INSTANCE.m2922Int$$$this$call$getdp$$arg2$callpadding$arg0$callSpacer$fun$anonymous$$arg3$callRow$fun$anonymous$$arg3$callColumn$fun$anonymous$$arg9$callSimpleCard$funRequiresLogPermissionCard()), 0.0f, 11, (Object) null), $composer4, 0);
            Composer $composer5 = $composer4;
            Composer $composer6 = $composer3;
            Function0 function06 = function04;
            Function3 function32 = skippableUpdate$iv$iv$iv3;
            PrimaryButtonKt.PrimaryButton((Modifier) null, StringResources_androidKt.stringResource(C0001R$string.grant, $composer4, 0), function04, false, $composer5, (i2 << 6) & 896, 9);
