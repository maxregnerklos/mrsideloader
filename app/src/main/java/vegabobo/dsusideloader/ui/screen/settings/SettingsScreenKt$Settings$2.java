...
public final class SettingsScreenKt$Settings$2 extends Lambda implements Function3 {
    public final /* synthetic */ int $$dirty;
    public final /* synthetic */ Function1 $navigate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SettingsScreenKt$Settings$2(Function1 function1, int i) {
        super(3);
    ...
    public final void invoke(TopAppBarScrollBehavior it, Composer $composer, int $changed) {
        ...
        ComposerKt.sourceInformation(composer, "C37@1445L38,39@1558L29,36@1410L192:SettingsScreen.kt#u9sfrg");
        int $dirty = $changed;
        if (($changed & 14) == 0) {
        ...
        if (($dirty2 & 91) != 18 || !$composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1171384399, $dirty2, -1, "vegabobo.dsusideloader.ui.screen.settings.Settings.<anonymous> (SettingsScreen.kt:35)");
            }
            String stringResource = StringResources_androidKt.stringResource(C0001R$string.settings, composer, 0);
            ...
            if (invalid$iv$iv || it$iv$iv == Composer.Companion.getEmpty()) {
                value$iv$iv = new SettingsScreenKt$Settings$2$1$1(function1);
