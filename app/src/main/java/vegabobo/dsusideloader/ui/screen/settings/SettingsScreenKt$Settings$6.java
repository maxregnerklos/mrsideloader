...
public final class SettingsScreenKt$Settings$6 extends Lambda implements Function0 {
    public final /* synthetic */ SettingsViewModel $settingsViewModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SettingsScreenKt$Settings$6(SettingsViewModel settingsViewModel) {
        super(0);
